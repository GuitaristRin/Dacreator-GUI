...
CONFIG = {
    ...
    "player_id_path": "Player_ID.dat",           # 占位，后面更新为绝对路径
    "standard_time_path": "./assets/rank.csv",   # 占位
    "timeout": 30,
    "max_retry": 3,
    "course_name_map": {
...
# 计算项目根目录（假设 method 文件夹在项目根目录下）
BASE_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
CONFIG["player_id_path"] = os.path.join(BASE_DIR, "Player_ID.dat")
CONFIG["standard_time_path"] = os.path.join(BASE_DIR, "assets", "rank.csv")
